...
$.AdminSwift = {}, $.AdminSwift.options = {
    ...
    activate: function () {
        ...
        $(window).click(function (e) {
            var i = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (i = $(e.target).parent()), !i.hasClass("bars") && t.isOpen() && 0 === i.parents("#leftsidebar").length && (i.hasClass("js-right-sidebar") || r.fadeOut(), a.removeClass("overlay-open"))
            ...
            if ($(i.parents("ul")[0]).hasClass("list")) {
                ...
                $.each($(".menu-toggle.toggled").not(a).next(), function (e, i) {
                    $(i).is(":visible") && ($(i).prev().toggleClass("toggled"), $(i).slideUp())
                })
            }
            i.toggleClass("toggled"), t.slideToggle(320)
        }), t.setMenuHeight(), t.checkStatuForResize(!0), $(window).resize(function () {
    ...
    setMenuHeight: function () {
        if (void 0 !== $.fn.slimScroll) {
            var e = $.AdminSwift.options.leftSideBar,
                i = $(window).height() - ($(".legal").outerHeight() + $(".user-info").outerHeight() + $(".navbar").innerHeight()),
                t = $("");
            t.slimScroll({
                destroy: !0
            }).height("auto"), t.parent().find(".slimScrollBar, .slimScrollRail").remove(), t.slimscroll({
                height: i + "px",
                color: e.scrollColor,
                size: e.scrollWidth,
    ...
    checkStatuForResize: function (e) {
        var i = $("body"),
            ...
            a = i.width();
        e && i.find(".content, .sidebar").addClass("no-animate").delay(1e3).queue(function () {
            $(this).removeClass("no-animate").dequeue()
        }), a < 1170 ? (i.addClass("ls-closed"), t.fadeIn()) : (i.removeClass("ls-closed"), t.fadeOut())
    },
    isOpen: function () {
    ...
    activate: function () {
        ...
        $(window).click(function (e) {
            var i = $(e.target);
            "i" === e.target.nodeName.toLowerCase() && (i = $(e.target).parent()), !i.hasClass("js-right-sidebar") && t.isOpen() && 0 === i.parents("#rightsidebar").length && (i.hasClass("bars") || r.fadeOut(), a.removeClass("open"))
        }), $(".js-right-sidebar").on("click", function () {
            a.toggleClass("open"), t.isOpen() ? r.fadeIn() : r.fadeOut()
        })
    },
    isOpen: function () {
    ...
    activate: function () {
        ...
        $(".bars").on("click", function () {
            e.toggleClass("overlay-open"), e.hasClass("overlay-open") ? i.fadeIn() : i.fadeOut()
        }), $('.nav [data-close="true"]').on("click", function () {
            var e = $(".navbar-toggle").is(":visible"),
                i = $(".navbar-collapse");
            e && i.slideUp(function () {
...
function skinChanger() {
    $(".right-sidebar .demo-choose-skin li").on("click", function () {
        ...
        $(".right-sidebar .demo-choose-skin li").removeClass("active"), e.removeClass("theme-" + t), i.addClass("active"), e.addClass("theme-" + i.data("theme"))
    })
}
...
function setSkinListHeightAndScroll() {
    ...
    i.slimScroll({
        destroy: !0
    }).height("auto"), i.parent().find(".slimScrollBar, .slimScrollRail").remove(), i.slimscroll({
        height: e + "px",
...
$.AdminSwift.browser = {
    ...
    $.AdminSwift.browser.activate(), $.AdminSwift.leftSideBar.activate(), $.AdminSwift.rightSideBar.activate(), $.AdminSwift.navbar.activate(), $.AdminSwift.input.activate(), $.AdminSwift.select.activate(), setTimeout(function () {
        $(".page-loader-wrapper").fadeOut()
    }, 50)
}), $(window).scroll(function () {
    30 <= $(window).scrollTop() ? $(".clearHeader").addClass("n-top") : $(".clearHeader").removeClass("n-top"), 30 <= $(window).scrollTop() ? $(".morphsearch").addClass("m-top") : $(".morphsearch").removeClass("m-top")
}), $(function () {
    ...
    var i = document.getElementById("morphsearch"),
        ...
        r = function (e) {
            ...
            a ? (classie.remove(i, "open"), "" !== t.value && setTimeout(function () {
                classie.add(i, "hideInput"), setTimeout(function () {
                    classie.remove(i, "hideInput"), t.value = ""
                }, 300)
            }, 500), t.blur()) : classie.add(i, "open"), a = !a
        };
    t.addEventListener("focus", r), e.addEventListener("click", r), document.addEventListener("keydown", function (e) {
        27 === (e.keyCode || e.which) && a && r(e)
    }), i.querySelector('button[type="submit"]').addEventListener("click", function (e) {
        // e.preventDefault()
    })
});